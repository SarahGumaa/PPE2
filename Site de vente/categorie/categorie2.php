<?php include_once("../assets/header2.php");?>
    ...
    <div class="header_bottom_left">				
        <div class="categories">
            <ul>
                ...
                <li class="active"><a href="categorie2.php">Fournitures</a></li>
                <li><a href="categorie3.php">Meubles</a></li>
                <li><a href="categorie4.php">Accessoires</a></li>
...
<div class="main">
    <div class="content">
        <div class="content_top">
            <div class="heading">
                <h3>Fournitures - Sous catégorie</h3>
            </div>
            <div class="see">
